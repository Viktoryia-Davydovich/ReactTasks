...
import { emailSelector, passwordSelector } from "../LoginReduxForm/LoginReduxFormSelectors";
...
export default connect(mapStateToProps)(withStyles(styles)(LoginReduxFormSuccess))
